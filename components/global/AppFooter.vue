    ...
    <div class="container">
      <div class="footer-content">
        <div class="footer-section">
          ...
          <p class="footer-intro">
            Исторические данные на платформе основаны на проверенных научных источниках, музейных коллекциях и архивных материалах. Каждый объект хронологии имеет свой набор источников.
          </p>
        ...
        <div class="footer-section">
          <h3 class="section-title">О платформе</h3>
          <p class="footer-text">
        ...
        <div class="footer-section">
          <h3 class="section-title">Структура платформы</h3>
          <ul class="info-list">
            <li>📍 Автопоток: автомобилестроение России</li>
            <li>📍 Параллельные направления: транспорт других видов</li>
            <li>📍 Фильтры: тип, год, массовая эксплуатация, название</li>
      ...
      <div class="footer-bottom">
        <p class="footer-copyright">
          Проект создан в образовательных целях • История техники России • 2026
        </p>
      </div>
    </div>
  </footer>
...
const sourceList = computed(() => {
  ...
  return `Всего в платформе ${mainline} объекта автопотока и ${adjacent} параллельных объектов, всего ${all.length} вех транспортной истории.`
})
</script>
